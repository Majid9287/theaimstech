    ...
    <footer className="  bg-neutral-200 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
      <div className="flex justify-center items-center pt-6">
        ...
        >
          <FontAwesomeIcon
            icon={faWhatsapp}
            style={{ color: whatsappIconColor, fontSize: "2rem" }}
          />
        </a>
        ...
        >
          <FontAwesomeIcon
            icon={faFacebook}
            style={{ color: facebookIconColor, fontSize: "2rem" }}
          />
        </a>
        ...
        >
          <FontAwesomeIcon
            icon={faLinkedin}
            style={{ color: linkedinIconColor, fontSize: "2rem" }}
          />
        </a>
        ...
        >
          <FontAwesomeIcon
            icon={faInstagram}
            style={{ color: instagramIconColor, fontSize: "2rem" }}
          />
        </a>
      </div>
      ...
      <div className="px-10 mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="">
            <h6 className="mb-4 mr-8 flex items-center justify-center font-semibold uppercase md:justify-start">
              <img src="images/aims11.png" alt="" />
            </h6>
            <p>
              We provide cutting-edge e-commerce solutions to drive business
              success, exceeding client expectations and empowering online
              growth.
            </p>
          </div>
          <div className="">
      ...
      <div className="bg-white  backdrop-filter backdrop-blur-lg bg-opacity-30 p-6 text-center dark:bg-neutral-700">
        ...
        <Link
          className="font-semibold mr-2 px-4 text-neutral-600 dark:text-neutral-400"
          href="https://programmingdrip.com/"
        >
          Powered By<span className="text-blue-700"> ProgrammingDrip</span>
        </Link>
      </div>
    </footer>
  );
