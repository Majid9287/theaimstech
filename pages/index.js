        ...
        <div className=" bg-gray-100">
          <div className="pt-5 md:pt-24 bg-gray-100 min-h-screen">
            <div className="container px-3 mx-auto flex flex-col items-center justify-center md:flex-row pt-20 sm:pt-8 ">
              ...
              <div className="text-center w-full md:w-3/5 md:order-last">
                <Lottie
                  animationData={hero}
                  loop={true}
                  className="w-full md:w-5/6 lg:w-4/5 mx-auto"
                />
              </div>
            </div>
          </div>
          ...
          <section className=" container grid grid-cols-1 md:grid-cols-2 items-center h-screen">
